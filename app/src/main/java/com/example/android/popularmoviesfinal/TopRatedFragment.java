...
public class TopRatedFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Movies>> {
    ...
    private static final String MOVIES_REQUEST_URL = "https://api.themoviedb.org/3/movie/top_rated";
